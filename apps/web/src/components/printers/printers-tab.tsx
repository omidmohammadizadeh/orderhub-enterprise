...
function PrinterWizard({
  ...
  // iOS/iPadOS can't reach Bluetooth Classic (SPP) thermal printers —
  // Apple restricts them to MFi-certified accessories, so the paired-device
  // scan always comes back empty on an iPad. Detect it (SSR-safe) so we can
  // show the right guidance and steer the operator to a LAN printer.
    ...
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-zinc-900/40 p-4">
      <div className="w-full max-w-xl rounded-lg bg-white shadow-xl">
        ...
        <div className="space-y-4 p-5 max-h-[70vh] overflow-y-auto">
          <Section title="Automatic printing">
