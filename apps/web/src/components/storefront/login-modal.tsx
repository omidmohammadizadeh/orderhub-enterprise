...
function GoogleButtonStub() {
  return (
    <button
      type="button"
      disabled
      title="Google sign-in coming next"
      className="flex w-full items-center justify-center gap-2 rounded-lg border border-zinc-200 bg-white px-4 py-2.5 text-sm font-semibold text-zinc-400"
    >
      <svg viewBox="0 0 24 24" className="h-4 w-4" aria-hidden="true">
        ...
        <path
          fill="#FBBC05"
          d="M5.84 14.1A6.6 6.6 0 0 1 5.5 12c0-.73.12-1.43.34-2.1V7.07H2.18a11 11 0 0 0 0 9.86l3.66-2.83Z"
        />
        <path
          fill="#EA4335"
